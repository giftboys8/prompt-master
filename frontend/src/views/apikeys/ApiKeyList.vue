<template>
  <div class="api-key-list">
      ...
      <el-table v-loading="loading" :data="apiKeys" style="width: 100%">
        ...
        <el-table-column prop="key" label="秘钥">
          <template #default="scope">
            <div class="key-container">
              ...
              <el-button link type="primary" @click="showKey(scope.row)">查看</el-button>
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="250">
          <template #default="scope">
            ...
            <el-button link type="primary" @click="handleValidate(scope.row)">验证</el-button>
    ...
    <!-- 添加/编辑对话框 -->
    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑秘钥' : '添加秘钥'" width="500px">
...
import { getApiKeys, createApiKey, updateApiKey, deleteApiKey, validateApiKey, ApiKeyData } from '@/api/apikeys';
...
// 复制秘钥
const copyKey = () => {
  navigator.clipboard.writeText(currentKey.value.key || '')
    .then(() => {
