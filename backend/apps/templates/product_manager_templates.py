...
def create_product_manager_templates(user_id):
    user = User.objects.get(id=user_id)
    framework = Framework.objects.get(name='CUSTOM')  # 假设我们使用自定义框架
    ...
    print(f"Successfully created {len(templates)} product manager templates.")

# 使用方法：create_product_manager_templates(user_id)
# 其中user_id是创建模板的用户ID